        ...
        <div className="container mx-auto px-6 flex flex-col justify-between items-center relative py-8">
            <div className="z-20 flex flex-col">
                ...
                <h2 className="font-light max-w-2xl mx-auto w-full text-xl text-gray-500 text-center py-8">
                    A super simple page builder, designed and developed so that You can create stuning CVs, Resumes or Portfolios without any technical knowledge! 
                </h2>
                <div className="flex items-center justify-center mt-4 mb-10">
                    <button className="uppercase m-2 py-2 px-4 bg-transparent shadow-md rounded-2xl border-2 border-[#f92c85] text-[#5ebec4]  text-md">
                       Get Started
                    </button>
                    <button className="uppercase m-2 py-2 px-4 bg-transparent shadow-md rounded-2xl border-2 border-[#f92c85] text-[#5ebec4] text-md">
                        Learn More
